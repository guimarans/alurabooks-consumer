import { AbBotao, AbGrupoOpcao, AbGrupoOpcoes, AbInputQuantidade, AbTag } from 'alura-books-ds-guimarans';
    ...
    return (
        <section className='livro-detalhe'>
            ...
            <div className='wrap'>
                ...
                <div className='tags'>
                    {data?.livro.tags?.map(tag => <AbTag texto={tag.nome} tipo='secundario' key={tag.id} />)}
                </div>
            </div>
        </section>
    )
